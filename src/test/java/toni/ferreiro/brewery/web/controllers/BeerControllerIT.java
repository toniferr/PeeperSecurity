...
public class BeerControllerIT extends BaseIT{
    ...
    void initCreationFormWithSpring() throws Exception {
        mockMvc.perform(get("/beers/new").with(httpBasic("toni", "fercou")))
    ...
    @Test
    void initCreationFormWithUser2() throws Exception {
        mockMvc.perform(get("/beers/new").with(httpBasic("user2", "pass2")))
                .andExpect(status().isOk())
                .andExpect(view().name("beers/createBeer"))
                .andExpect(model().attributeExists("beer"));
    }
